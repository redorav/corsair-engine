...
void CrGraphicsPipelineD3D12::RecompilePS(crgfx::ICrRenderDevice* renderDevice, const CrGraphicsShaderHandle& graphicsShader)
{
	Deinitialize();
	Initialize(static_cast<CrRenderDeviceD3D12*>(renderDevice), m_pipelineDescriptor, graphicsShader, m_vertexDescriptor);
}

void CrComputePipelineD3D12::RecompilePS(crgfx::ICrRenderDevice* renderDevice, const CrComputeShaderHandle& computeShader)
{
	Deinitialize();
