...
public:
	...
	crgfx::ShaderResourceType::T type = crgfx::ShaderResourceType::Count;

	static CrShaderResource Invalid;
};

// Make sure we don't allocate any memory on the heap
using ShaderReflectionFunction = crstl::fixed_function<12, void(crgfx::ShaderStage::T stage, const CrShaderResource&)>;
...
public:
	...
	virtual void AddBytecode(const CrShaderBytecodeHandle& bytecode) = 0;
