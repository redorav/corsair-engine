...
namespace crgfx
{
	...
	void ShaderBindingLayout::ProcessResourceArray(crgfx::ShaderResourceType::T resourceType, const ResourcesT& resources)
	{
		...
		for (const ShaderBinding& shaderBinding : resources)
		{
	...
	ShaderBindingLayout::ShaderBindingLayout(const ShaderBindingLayoutResources& resources)
	{
