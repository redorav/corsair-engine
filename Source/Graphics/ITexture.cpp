...
namespace crgfx
{
	...
	crgfx::MipmapLayout ITexture::GetDDSMipSliceLayout(crgfx::DataFormat::T format, uint32_t width, uint32_t height, uint32_t depth, uint32_t numMipmaps, bool isVolume, uint32_t mip, uint32_t slice)
	{
	...
	crgfx::MipmapLayout ITexture::GetDDSMipSliceLayout(uint32_t mip, uint32_t slice) const
	{
		return GetDDSMipSliceLayout(m_format, m_width, m_height, m_depth, m_mipmapCount, IsVolumeTexture(), mip, slice);
	}

	crgfx::MipmapLayout ITexture::GetHardwareMipSliceLayout(uint32_t mip, uint32_t slice) const
	{
	...
	void ITexture::CopyIntoTextureMemory(uint8_t* destinationData, const uint8_t* sourceData, uint32_t mip, uint32_t slice)
	{
	...
	void ITexture::CopyIntoTextureMemory
	(
