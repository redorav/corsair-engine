...
namespace crgfx
{
	...
	void CommandBufferVulkan::ResetGPUQueriesPS(const ICrGPUQueryPool* queryPool, uint32_t start, uint32_t count)
	{
	...
	void CommandBufferVulkan::ResolveGPUQueriesPS(const ICrGPUQueryPool* queryPool, uint32_t start, uint32_t count)
	{
		const CrGPUQueryPoolVulkan* vulkanQueryPool = static_cast<const CrGPUQueryPoolVulkan*>(queryPool);
	...
	void CommandBufferVulkan::EndRenderPassPS()
	{
	...
	void CommandBufferVulkan::QueueVkImageBarrier(const crgfx::ITexture* texture, uint32_t mipmapStart, uint32_t mipmapCount, uint32_t sliceStart, uint32_t sliceCount,
	...
	void CommandBufferVulkan::FlushImageAndBufferBarriers()
	{
	...
	void CommandBufferVulkan::BeginPS()
	{
	...
	void CommandBufferVulkan::ClearRenderTargetPS(const crgfx::ITexture* renderTarget, const float4& color, uint32_t mip, uint32_t slice, uint32_t mipCount, uint32_t sliceCount)
	{
	...
	void CommandBufferVulkan::EndPS()
	{
