...
CrGPUQueryPoolD3D12::CrGPUQueryPoolD3D12(ICrRenderDevice* renderDevice, const CrGPUQueryPoolDescriptor& descriptor) : ICrGPUQueryPool(renderDevice, descriptor)
{
	...
	CrHardwareGPUBufferDescriptor queryBufferDescriptor(cr3d::BufferUsage::TransferDst, (cr3d::BufferAccess::T)(cr3d::BufferAccess::GPUWrite | cr3d::BufferAccess::CPURead), descriptor.count, m_querySize);
