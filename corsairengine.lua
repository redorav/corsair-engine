...
SourceGraphicsDirectory  = SourceDirectory..'/Graphics'
SourceShadersDirectory   = SourceGraphicsDirectory..'/Shaders'
SourceWorldDirectory     = SourceDirectory..'/World'
...
SourceShaderCompilerDirectory = SourceGraphicsDirectory..'/ShaderCompiler'
ShaderMetadataFilename = "ShaderMetadata"
BuiltinShadersFilename = "BuiltinShaders"

project(ProjectGraphics)
	kind('StaticLib')
	pchheader('Graphics/CrRendering_pch.h')
	pchsource(SourceGraphicsDirectory..'/CrRendering_pch.cpp')
	...
	files
	{
		SourceGraphicsDirectory..'/*',
		SourceGraphicsDirectory..'/UI/*',
		SourceGraphicsDirectory..'/FrameCapture/*',
		SourceGraphicsDirectory..'/RenderWorld/*',
		SourceGraphicsDirectory..'/Material/*',
	...
	includedirs { SourceGraphicsDirectory }
	...
	filter { Win64PlatformFilter }
		files { SourceGraphicsDirectory..'/Vulkan/**' }
		files { SourceGraphicsDirectory..'/D3D12/**' }
		files { SourceGraphicsDirectory..'/Extensions/**' }
...
project(ProjectShaderCompiler)
	...
	pchheader('Graphics/ShaderCompiler/CrShaderCompiler_pch.h')
